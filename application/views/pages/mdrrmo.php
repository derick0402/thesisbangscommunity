        ...
        <div id="carouselImages" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="erralogo" src="<?php echo base_url();?>assets/images/slider/img-1.jpg" alt="erra">
                </div>
                <div class="carousel-item">
                    <img class="erralogo" src="<?php echo base_url();?>assets/images/slider/img-2.jpg" alt="erra">
                </div>
                <div class="carousel-item">
                    <img class="erralogo" src="<?php echo base_url();?>assets/images/slider/img-3.jpg" alt="erra">
                </div>
            </div>
    ...
    <div id="contact">
        <div id="contactContent">
            ...
            <div class="row justify-content-md-center" data-aos="fade-left" data-aos-duration="1000">
                ...
                <div class="col-lg-2">
                    <p class="hotlineNumber">(046) 413-0188</p>
                </div>
            </div>
    ...
    <div id="about" >
        <div id="aboutContent" >
            ...
            <p id="descriptions" data-aos="fade-right" data-aos-duration="1000">
                ...
                ERRA provides awareness to the community of Carmona and help store their data and 
            ...
            <p id="descriptions" data-aos="fade-right" data-aos-duration="1000">
                ...
                Risk Reduction and Management Council. They can also visit 
                their official <a target="_blank" href="https://www.facebook.com/CarmonaMDRRMC/">Facebook Account</a> for more information.
            </p>
        </div>
    </div>
    <br/><br/>
